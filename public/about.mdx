...
More concretely, after reading the mini-course, you should get a solid theoretical background behind a lot of tricks used in machine learning. Here's some questions we will explore. 
...
- How to think about LLMs? (chapters 4 and 7)


<Expand headline = "How to read this">

Skip stuff you find boring, especially expanding boxes and doubly especially boxes labeled with ⚠️. Follow links, get nerdsniped, and don't feel the need to read this linearly. 
...
The total length of the text, if you skip most expand boxes and footnoes, is about 2 chapters of Harry Potter and the Philosopher's stone (until Harry's first experience with magic). It's about 5 chapters if you read all footnotes and expand boxes (Harry learns he's a wizard). In either case, I don't promise you will feel the same as Harry.  
...
<Expand headline = "What is assumed"> <a id="what-we-assume"></a>
...
<Expand headline = "About This Project">
...
More concretely, it's motivated by two open problems:
