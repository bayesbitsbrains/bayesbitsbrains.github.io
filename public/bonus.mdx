...
We explore the fascinating concept of Kolmogorov complexity - a fundamental measure of the intrinsic complexity of data. This chapter shows how the shortest computer program needed to generate a string captures its "true" information content, independent of any particular probability distribution. We'll see connections to compression, randomness, and machine learning.
