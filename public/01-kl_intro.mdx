...
<HistoryExpand headline = "Bayes versus Hume">

<ImageGallery
images={[
{ src: "/fig/bayes.gif", alt: "Thomas Bayes" },
{ src: "/fig/hume.jpg", alt: "David Hume" },
{ src: "/fig/price.jpg", alt: "Richard Price" }
]}
caption={"Thomas Bayes (left), David Hume (middle), Richard Price (right)"}
/>

[Thomas Bayes](https://en.wikipedia.org/wiki/Thomas_Bayes) was a Presbyterian minister who dabbled in mathematics. He never published his famous theorem — it only saw daylight after his death, when his friend [Richard Price](https://en.wikipedia.org/wiki/Richard_Price) found it among his papers.

But why did a minister develop the mathematics of probability? The evidence points to philosophy, not practicality. In 1748, philosopher [David Hume](https://en.wikipedia.org/wiki/David_Hume) posed what's now known as [the problem of induction](https://en.wikipedia.org/wiki/Problem_of_induction): How can we justify reasoning from past observations to future predictions? Why should seeing the sun rise a thousand times make us confident it will rise tomorrow? Hume argued there's no rational foundation for induction — it's just habit and custom.

Bayes' theorem — found in his notes between entries dated 1746 and 1749 — was likely his answer. If our detective starts with some prior probability for the sun rising and updates diligently using Bayes' rule, she'll quickly become certain about tomorrow's sunrise. Our belief in tomorrow is thus sensible and grounded in mathematics.

When Price discovered this work after Bayes' death, he recognized its significance. Price, who was remarkably well-connected<Footnote>I think of him as an angel investor in the Enlightenment.</Footnote>, made it known both to leading French scientists (and perhaps also to Hume). That took some time, though. Bayes' contribution was first acknowledged in early 1780's, but at that point, the theorem has already been an old news. [Pierre Laplace](https://en.wikipedia.org/wiki/Pierre-Simon_Laplace) has already rederived it himself and started applying it to scientific problems left and right. 
</HistoryExpand>

<HistoryExpand headline = "The certainty of uncertainty">

<ImageGallery
images={[
{ src: "/fig/laplace.jpg", alt: "Pierre Laplace" },
]}
caption={"Pierre Laplace"}
/>

If anyone deserves the title 'father of probability theory,' it's [Pierre Laplace](https://en.wikipedia.org/wiki/Pierre-Simon_Laplace). His 1812 masterpiece, [*Théorie analytique des probabilités*](https://www.goodreads.com/book/show/8537001-th-orie-analytique-des-probabilit-s), essentially created the field as we know it. The book remains a hit over 200 years later, sporting 5.00 stars on Goodreads.<Footnote>Admittedly, from a single voter.</Footnote>

Laplace lived in the shadow of Newton's triumph — a few simple laws that seemed to explain all of physics. Like his contemporaries, Laplace was captivated by this deterministic vision. He even created the famous thought experiment now known as [Laplace's demon](https://en.wikipedia.org/wiki/Laplace%27s_demon): if you knew the complete state of the universe at any moment, you could calculate its entire future.

So here's the question: why did the arch-determinist like Laplace devoted much of his career to developing probability theory, especially the parts relevant to Bayes' rule from this chapter? Interestingly, it was his deterministic worldview that actually *motivated* this work. Laplace recognized that complete knowledge of the universe was beyond our reach anyway. We are all detectives in a desperate need of a language to handle our inevitable uncertainty — probability.
</HistoryExpand>
