...
<Expand headline = "Laplace's demons">
...
If there is a person we can call the 'father of probability theory', it would be [Pierre Laplace](https://en.wikipedia.org/wiki/Pierre-Simon_Laplace) who developed big parts of the probability theory. In fact, his 1812 masterpiece [book on probability](https://www.goodreads.com/book/show/8537001-th-orie-analytique-des-probabilit-s) pretty much defined the whole field. It remains a hit 200+ years later, with 5.00 stars on Goodreads.<Footnote>Admittedly, there's only one voter. </Footnote>

Around Laplace's time, everybody, himself included, was amazed by how Newton seemingly solved physics by postulating a few simple laws that seemed to exactly describe pretty much all there is. In fact, Laplace himself is the author of [Laplace’s demon](https://en.wikipedia.org/wiki/Laplace%27s_demon) — a thought experiment about the idea that if you knew all the info about the present state of the universe, you could deterministically simulate it and know all there is about the future. 

Yet Laplace spent a lot of his time developing probability theory! He understood that we can never know all there is to the world anyway. Hence, we need a language — probability — to talk about our uncertainty.  
</Expand>
