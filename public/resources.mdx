...
Here are some great resources for further exploring related topics. 📚 stands for a book, 📝 for a blog posts / papers. I tried to assign each to one of the three parts of this mini-course, but books are often relevant for several parts. 
...
- 📝 [The principle of maximum entropy](https://caseychu.io/posts/maximum-entropy-kl-divergence-and-bayesian-inference/#:~:text=,one%20with%20the%20maximum%20entropy) by Casey Chu
