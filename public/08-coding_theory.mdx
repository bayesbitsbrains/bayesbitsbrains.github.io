...
You are done, congrats! If you liked the mini-course, continue to the [Graveyard](bonus.md) that contains bonus chapters that I dropped from the main flow. Check out the [resources](resources), too. I will be grateful if you leave feedback [here](https://forms.gle/wXShyQRsGWtb8afd6). 