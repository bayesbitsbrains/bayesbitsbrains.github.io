...
<ImageGallery images={[{src: "00-introduction/questions.png", alt: "questions"}]} width="150%" />
...
<ImageGallery images={[{src: "00-introduction/rod.png", alt: "rod"}]} width="200%" caption="Determining the length of the foot in [1522 Frankfurt](https://commons.wikimedia.org/wiki/File:Determination_of_the_rute_and_the_feet_in_Frankfurt.png)." />
