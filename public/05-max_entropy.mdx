...
<KeyTakeaway>
A new model $p$ improve an old one $p$ should have small $D(p, q)$. This leads to the maximum entropy principle explaining where many useful distributions are coming from. 
</KeyTakeaway>
